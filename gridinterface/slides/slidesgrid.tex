...
\begin{onlyenv}<presentation>
  \begin{frame} \frametitle{Design Principles}
    ...
    \item[Flexibility:]
      {Separation of data structures and algorithms.}\\[2ex]
    \item[Efficiency:]
...
\begin{frame} \frametitle{Flexibility}
  ...
  \framesubtitle<presentation>{Separate data structures and algorithms.}

  \only<article>{Separation of data structures and algorithms:}

  \begin{itemize}
  \item The algorithm determines the data structure to
    operate on.
...
\begin{frame} \frametitle{DUNE Release 2.7.1}
  \footnotesize
  \begin{columns}[t]
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \cmd{\Large dunecontrol}
      ...
      \item integrates with cmake \& git
...
\begin{frame}
  ...
  \pause
  \vspace*{5mm}
  \emph{Within todays exercises we will always assume $d=w$ and we will
