...
\begin{itemize}
  ...
  \item Compute residual contributions.
\end{itemize}
...
\lstinputlisting[linerange={66-68}, basicstyle=\ttfamily\small,
frame=single,
...
degree. See table \ref{table:quadrature} for a correspondence between
...
Parameters for the nonlinear Newton solver can be set in the \lstinline{[newton]} section of the
ini file.
