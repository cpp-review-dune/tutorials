...
\begin{frame}[fragile]
  ...
  \textbf{Introduction}
  \begin{itemize}
    \item \lstinline{dune-codegen}\footnote{https://gitlab.dune-project.org/extensions/dune-codegen} is a separate module
...
\begin{frame}
  ...
  \item Only describes cell/facet local computations. There is no notion of a
...
\begin{frame}[fragile]
  ...
  \item \lstinline{SOURCE}: \CC\ file used for building the target. This is
    optional, if omitted a minimal driver will be generated
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \item \lstinline{T}: End of time interval
